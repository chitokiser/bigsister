import { $, $$, toast, fmt, esc, nl2br, cryptoRandomId, getTS, db, State, ONCHAIN } from './utils.js';
...
$$("a[data-link]").forEach(a=>{
  a.addEventListener("click",(e)=>{
    ...
    location.hash = href?.replace("#/","") || ""; // Fix: remove #/ from hash
  });
});

// Export functions that need to be called from outside
export { renderRoute, refreshHome, refreshMy, refreshAgentState, renderAgentPipes, renderAdmin };